...
!function (a, b) {
    jPlayerPlaylist = function (b, c, d) {
        ...
        }), a(this.cssSelector.repeatOne).click(function (a) {
            a.preventDefault(), e.repeatOne(), e.blur(this)
        ...
        _createListItem: function (b) {
            ...
            return d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'><em>" + b.title + (b.artist ? " </em><i class='jp-artist'>" + b.artist + "</i></em>" : "</em>") + "</a>", d += "</div></li>"
        },
